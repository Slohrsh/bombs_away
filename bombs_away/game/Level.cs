...
using System.Linq;
using bombs_away.ui.elements.bombItem;
...
namespace bombs_away.game
{
    class Level
    {
        ...
        private List<BombItem> bombItems;
        ...
        {
            Block block = new Block(type, "char", new Box2D(0, 0, 0, 0), component.SizeX, component.MinX,
                component.MinY);
        ...
        {
            Block bombItem = (Block) sender;
            bombItem.IsVisible = false;
            
            
            if (!bombItem.isCollected)
            {
                availableAmountOfBombs++;
            }
            bombItem.isCollected = true;
        }
